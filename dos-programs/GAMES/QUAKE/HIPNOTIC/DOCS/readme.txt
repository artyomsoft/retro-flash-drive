=============================================================================
                  INSTRUCTIONS FOR QUAKE MISSION PACK #1
...
Please Note:  Alternative HTML and MS Word versions of this and the Manual 
              ...
              can find them in the Documents in the Quake\Hipnotic folder.
...
3) When asked to locate Quake.exe, use the folder explorer to locate your
   ...
   LOADED ON YOUR MACHINE BEFORE INSTALLING QUAKE MISSION PACK #1.  
   INSTALLATION WILL NOT PROCEED WITHOUT QUAKE.

4) The minimum specifications for Quake Mission Pack #1 are:

   MS®-DOS 5.0 or higher or Windows95®
   Pentium Processor
   16 MB RAM
   ...
   Pack #1 will not run properly.

5) NTR.net is an Internet Service Provider that facilitates the multi-player
   functions of both Quake and Quake Mission Pack #1.  When prompted, you can
   launch NTR.net’s installation program.  
...
2) When asked to locate Quake.exe, type the path name for your Quake
   ...
   QUAKE MISSION PACK #1.  INSTALLATION WILL NOT PROCEED WITHOUT QUAKE.

3) The minimum specifications for Quake Mission Pack #1 are:
...
-----------------------------------------------------------------------------
                 Installation Instructions for Windows NT
-----------------------------------------------------------------------------
NEITHER QUAKE NOR QUAKE MISSION PACK #1 WILL RUN UNDER WINDOWS NT!  NEITHER
OF THESE PRODUCTS ARE SUPPORTED UNDER WINDOWS NT BY ID OR ACTIVISION.
...
MULTIPLAYER (also accessed by hitting F5)
   ...
   NEW GAME - The options available here are the same as those in JOIN A 
      ...
      OK
         ...
         EPISODE - Selects the episode of Quake Mission Pack #1 in which 
